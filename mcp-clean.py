...
parser.add_argument("-i", "--input_file", dest = "input", help="Name of the input file", type = str, required=True)
parser.add_argument("-o", "--output_file", dest = "output",  help="Name of the output file", type = str, required=True)
parser.add_argument("-m", "--meta_file", dest = "meta", help="Name of the meta file", type = str, required=True)
parser.add_argument("-v", "--verbosity", dest = "verbosity", help="Verbosity", type = bool, required=False)
...
class Interpreter:
    def __init__(self, operations, csvin, csvout):
        ...
        self.csvout = open(csvout, "w", newline = "")
        self.reader = csv.reader(self.csvin)
...
def open_input(input):
    try:
        ...
        raise RuntimeError(f"Unable to open file {input}")
    except:
        raise RuntimeError(f"Unknown problem with the file {input}")
    return file

parser = Parser(args.meta)
# arr =[]
